...
import { use } from "react"; // React.use() para desempaquetar la promesa
...
export default function ProductDetail({ params: paramsPromise }: { params: Promise<{ sku: string }> }) {
  const { sku } = use(paramsPromise);
  ...
  return (
    <div className="grid grid-cols-12 justify-center items-center mt-10 space-y-12 p-5">
      <div className="col-span-12 items-center mb-6">
        ...
        <h1 className="text-center lilita-one-regular text-orange-700">
                  ...
                  <div className="mb-6" key={product.sku}>
                    <Card>
                      ...
                      <CardContent>
                        ...
                        <p>
                          <span className="font-bold">Código SKU:</span>{" "}
                          {product.sku}
                        </p>
                        <p>
            ...
            <div className="col-span-12 mb-4 flex justify-center mt-6">
              <div className="w-full sm:w-10/12 md:w-8/12 lg:w-6/12">
                <p className="text-center text-orange-950">
                  Lo sentimos, no tenemos información sobre este producto.
                </p>
              </div>
            </div>
          )}
